...
Single responsibility: give an architectural opinion on whether an issue or proposed change fits `DESIGN.md`. Does not write, edit, or create any file. Cadence, automatic PR-review gating versus advisory on-request: `standards/adversarial-review-protocol.md` § "Reviewer count by artifact".
