...
Full mechanics for `agents/orchestrator.md` § "Autonomous timed run (never-stop loop)". Read the
stub there first for the load condition; this file is the one link deeper it points to, and covers
the full procedure.
