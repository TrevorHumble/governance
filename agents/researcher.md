...
- Local paths to search (e.g., `agents/`, `standards/`, `.claude/skills/`, `.agents/skills/`, `data/wip-issues/`).
- Any formula, filter, or rule the plan names, so the existing-owner search has its target.
